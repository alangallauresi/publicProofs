...
% --------------------------------------------------------
% IMPORTANT: Abstract MUST be before \maketitle
% --------------------------------------------------------
\begin{abstract}
...
<ccs2012>
   ...
   <concept>
       ...
       <concept_desc>Mathematics of computing~Enumerative combinatorics</concept_desc>
...
\ccsdesc[300]{Mathematics of computing~Enumerative combinatorics}

\keywords{Geosodic Tree, Meltdown-Free Expansion, Balanced Growth, Computational Geometry, Data Structures, Discrete-Continuous Bridge, Enumerative Combinatorics}
